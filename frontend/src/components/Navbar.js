...
export const Navbar = () => {
  ...
  return (
    <div className='fixed w-full px-8 py-4 md:px-16 text-[#4d3319] font-serif bg-opacity-70 shadow-md' style={{ backdropFilter: 'blur(5px)', webkitBackdropFilter: 'blur(5px)'/* Set a higher z-index */ }}>
